  ...
  useEffect(() => {
    const load = async () => {
      ...
      try {
        ...
        const url = "/public/mocks/fixtures-mock.json" //`https://lancesports-fixtures-api.onrender.com/leagueFixtures`;"/public/mocks/fixtures-mock.json" uncomment if you wnat to use live api`https://lancesports-fixtures-api.onrender.com/leagueFixtures`;
