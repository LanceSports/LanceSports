...
export function PremierLeague() {
  ...
  // ✅ Unique team list for the filter (memoized)
  ...
  // ✅ Apply existing time filter, then team filter
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-green-950 to-gray-900 transition-colors duration-200">
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <p className="text-gray-300 max-w-2xl mx-auto">
            The Pinacle of English Football
          </p>
        </div>

        {/* ✅ Team Filter (non-intrusive, matches current styling) */}
        <div className="mb-4 flex justify-center">
          <div className="glass-card-dark rounded-xl px-3 py-2 flex items-center gap-3">
            ...
            >
              <option value="all" className="bg-gray-900">All teams</option>
              {uniqueTeams.map((t) => (
